...
namespace { // BEGIN_EMPTY_NAMESPACE
		...
		cppad_mixed&                    mixed_object    )
	{
		...
		{	// print the error message as a warning
			...
			//
			// Perhaps evaluating the original source will generate a
			// more usefull error message that generated by CppAD and
			// ipopt_random.
			a2_vector a2_theta(n_fixed), a2_u(n_random);
