...
#
cat << EOF > junk.sed
/CppAD::mixed::a[23]_double/d
/CppAD::mixed::a[23]_vector/d
/a2_vector version of ran_likelihood/d
s/a3_vector version of ran_likelihood/a1_vector version of ran_likelihood/
EOF
# -----------------------------------------------------------------------------
