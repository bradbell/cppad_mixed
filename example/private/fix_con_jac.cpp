...
// ----------------------------------------------------------------------------
/*
{xrst_begin fix_con_jac.cpp dev}

constraint_jac: Example and Test
################################
...
bool fix_con_jac_xam(void)
{
   ...
   mixed_object.fix_con_jac(fixed_vec, row, col, val);
