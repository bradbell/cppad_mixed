...
-------------------------------------------------------------------------- */
/*
$begin fix_likelihood_eval_xam.cpp$$
$spell
	CppAD
	cppad
	eval
...
$section fix_likelihood_eval: Example and Test$$
...
$code
$verbatim%example/private/fix_likelihood_eval_xam.cpp
	%0%// BEGIN C++%// END C++%1%$$
$$
...
bool fix_likelihood_eval_xam(void)
{
	bool   ok = true;
	...
	CppAD::vector<double> vec = mixed_object.fix_likelihood_eval(fixed_vec);
