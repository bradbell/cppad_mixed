...
% use label instead of default icon in bibliography
...
% defines a specific \TabbedItem just before it is used.
...
\item
Set the install prefix and choose debug / release for:
\pause

\begin{itemize}
\item
tools/install\_eigen.sh
\pause
\item
tools/install\_ipopt.sh
\pause
\item
tools/install\_suitesparse.sh
\pause
\item
tools/install\_cppad.sh
\pause
\end{itemize}

\item
tools/run\_cmake.sh: edit the run.
\pause
...
\item
tools/debian\_install.sh: puts it all together for a Debian system
\pause
