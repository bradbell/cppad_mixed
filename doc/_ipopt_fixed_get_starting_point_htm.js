...
var list_current0 = [
'ipopt_fixed_get_starting_point.htm#Syntax',
'ipopt_fixed_get_starting_point.htm#n',
'ipopt_fixed_get_starting_point.htm#init_x',
'ipopt_fixed_get_starting_point.htm#x',
'ipopt_fixed_get_starting_point.htm#init_z',
'ipopt_fixed_get_starting_point.htm#z_L',
'ipopt_fixed_get_starting_point.htm#z_U',
'ipopt_fixed_get_starting_point.htm#init_lambda',
'ipopt_fixed_get_starting_point.htm#lambda',
'ipopt_fixed_get_starting_point.htm#ok',
'ipopt_fixed_get_starting_point.htm#Prototype'
];
