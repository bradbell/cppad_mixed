...
'typedef  Types Defined in the CppAD Mixed Namespace  ',' syntax begin scalar a1_double a2_double a3_double vector s_vector d_vector a1_vector a2_vector a3_vector sparse sparse_rc d_sparse_rcv a1_sparse_rcv end ',
...
'ldlt_eigen_solve_H  Solve Linear Equations Using LDLT Factor  ',' syntax prototype private purpose ldlt_obj row val_in val_out ',
...
'ldlt_eigen.cpp  Example Using Eigen LDLT Factorization  ',' problem description constructor init pattern update logdet solve_h split sim_cov source code ',
...
'order2random  Second Order Representation of Random Effects, W(beta, theta, u)  ',' syntax prototype private mixed_object n_fixed n_random jac_a1fun a1_ldlt_ran_hes beta_theta_u example ',
...
'whats_new_18  Changes and Additions to cppad_mixed During 2018  ',' 08-22 08-20 08-18 08-09 08-08 07-25 07-12 06-30 06-29 06-20 06-14 06-09 06-04 05-21 05-07 05-03 04-06 03-22 03-10 02-20 02-12 02-11 02-10 02-08 02-07 02-05 01-23 01-22 01-21 01-15 01-14 ',
...
'wish_list  CppAD Mixed Wish List  ',' sparse matrix d_sparse_rcv aborting optimization second order method random constraints windows install ',
