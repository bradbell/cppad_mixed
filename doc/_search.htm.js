...
Keyword = 
[
'cppad_mixed  C++ Laplace Approximation of Mixed Effects Models: cppad_mixed-20180629  ',' license source code repository notation fixed theta random data z prior density p(theta) p(z|theta) p(u|theta) p(y|thetau) constraint function c(theta) optimal u^(theta) matrix a*u^(theta) problem maximum likelihood constraints negative log-density vector ',
'install_unix  Installing cppad_mixed in Unix  ',' system requirements c++ compiler git cmake pkg-config wget fortran gsl suitesparse download special run_cmake.sh eigen ipopt command check speed example installation linking using ',
'example_install.sh  An Example Installation  ',' syntax existing source ',
'run_cmake.sh  bin/run_cmake.sh: User Configuration Options  ',' verbose_makefile build_type cppad_prefix eigen_prefix ipopt_prefix debug release cppad_cxx_flags cmake_libdir ldlt_cholmod checkpoint_newton_step optimize_cppad_function for_hes_sparsity testing speed memory ',
...
'configure.hpp  Preprocessor Configuration Symbols in configure.hpp  ',' private cppad_mixed_version cppad_mixed_for_hes_sparsity cppad_mixed_optimize_ad_function cppad_mixed_checkpoint_newton_step cppad_mixed_ldlt_cholmod cppad_mixed_ldlt_class cppad_mixed_null_ptr ',
...
'whats_new_18  Changes and Additions to cppad_mixed During 2018  ',' 06-29 06-20 06-14 06-09 06-04 05-21 05-07 05-03 04-06 03-22 03-10 02-20 02-12 02-11 02-10 02-08 02-07 02-05 01-23 01-22 01-21 01-15 01-14 ',
