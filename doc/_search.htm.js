...
{ tag: 'run_cmake.sh', title:'bin/run_cmake.sh: User Configuration Options', other:' verbose_makefile build_type cppad_prefix eigen_prefix ipopt_prefix debug release extra_cxx_flags cmake_libdir ldlt_cholmod optimize_cppad_function for_hes_sparsity testing speed memory' },
...
{ tag: 'theory', title:'Laplace Approximation for Mixed Effects Models', other:' reference total likelihood random f(theta u) assumption fixed g(theta) optimal u^(theta) objective h(theta r(theta) l(theta) derivative constraints approximate first order u(beta second w(beta h(beta function b(beta hessian sparse observed information' },
{ tag: 'base_class', title:'cppad_mixed: Public Declarations', other:' types user defined functions ran_likelihood fix_likelihood fix_constraint fatal_error warning constructor destructor initialize optimize_random optimize_fixed information_mat sample_fixed sample_random' },
...
{ tag: 'information_mat', title:'Compute the Observed Information For Fixed Effects', other:' syntax purpose quasi_fixed mixed_object solution random_opt information_rcv example' },
{ tag: 'information_mat.cpp', title:'Observed Information Matrix: Example and Test', other:' model' },
{ tag: 'sample_fixed', title:'Sample Posterior for Fixed Effects', other:' syntax see also prototype public purpose constant constraints covariance manage_gsl_rng mixed_object information_rcv solution fixed_lower fixed_upper random_opt example other method' },
...
{ tag: 'sample_random', title:'Simulation the Posterior Distribution for Random Effects', other:' syntax see also prototype public purpose manage_gsl_rng mixed_object random_ipopt_options fixed_vec random_lower random_upper random_in covariance example' },
...
{ tag: 'whats_new_20', title:'Changes and Additions to cppad_mixed During 2020', other:' 03-15 api' },
