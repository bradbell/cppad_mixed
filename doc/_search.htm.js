...
Keyword = 
[
'cppad_mixed  C++ Laplace Approximation of Mixed Effects Models: cppad_mixed-20171210  ',' license source code repository notation fixed theta random data z prior density p(theta) p(z|theta) p(u|theta) p(y|thetau) constraint function c(theta) optimal u^(theta) matrix a*u^(theta) problem maximum likelihood constraints negative log-density vector ',
'install_unix  Installing cppad_mixed in Unix  ',' download system requirements c++ compiler cmake pkg-config wget fortran gsl special run_cmake.sh eigen ipopt suitesparse command check speed example installation linking using ',
...
'private  cppad_mixed: Private Declarations  ',' n_fixed_ n_random_ quasi_fixed_ bool_sparsity_ a_rcv_ initialize_done_ cppad_error_handler ran_like_fun_ ran_like_a1fun_ ran_hes_fun_ ldlt_ran_hes_ hes_cross_ newton_checkpoint_ laplace_obj_fun_ laplace_obj_hes_ fix_like_fun_ fix_like_jac_ fix_like_hes_ fix_con_fun_ fix_con_jac_ fix_con_hes_ template member functions pack unpack initialization init_ldlt_ran_hes init_fix_con init_fix_like init_hes_cross init_ran_hes init_ran_hes_check init_laplace_obj_hes init_ran_like init_ran_objcon try try_initialize try_optimize_random try_optimize_fixed try_information_mat try_sample_fixed sample_random other fix_con_eval fix_like_eval logdet_jac ran_con_eval ran_con_jac ran_like_jac ran_like_jac_check ran_obj_eval ran_obj_jac update_factor ',
...
'initialize  Initialization After Constructor  ',' syntax public purpose mixed_object fixed_vec random_vec ran_likelihood_jac ran_likelihood_hes size_map example ',
...
'init_ran_hes  Initialize Hessian of Random Likelihood w.r.t Random Effects  ',' syntax private mixed_object fixed_vec random_vec ran_hes_rcv_ ran_hes_work_ ran_like_fun_ index order ran_hes_fun_ ',
'init_ran_hes_check  Check User Defined ran_likelihood_hes  ',' syntax private mixed_object fixed_vec random_vec ran_like_fun_ ran_hes_rcv_ ran_hes_work_ ',
'ran_hes_fun.cpp  ran_hes_fun_: Example and Test  ',' private ',
'init_ran_objcon  Second Order Representation of Laplace Objective and Constraints  ',' syntax private mixed_object fixed_vec random_vec laplace_obj_fun_ ',
'init_ldlt_ran_hes  Initialize Cholesky Factor of Hessian of Random Likelihood  ',' syntax private mixed_object ran_hes_rcv_ ldlt_ran_hes_ ',
'init_fix_con  Initialize Constraints as Function of Fixed Effects  ',' syntax private mixed_object fixed_vec init_fix_con_done_ fix_con_fun_ fix_con_jac_ fix_con_hes_ ',
'init_fix_like  Initialize Fixed Likelihood  ',' syntax private mixed_object fixed_vec init_fix_like_done_ fix_like_fun_ fix_like_jac_ fix_like_hes_ ',
'init_hes_cross  Cross Terms of Sparse Hessian w.r.t Fixed and Random Effects  ',' syntax private mixed_object fixed_vec random_vec hes_cross_ ran_like_fun_ ran_like_a1fun_ order example ',
'hes_cross.cpp  Hessian Cross Terms: Example and Test  ',' private ',
'init_laplace_obj_hes  Initialize Hessian of Approximate Laplace Objective  ',' syntax private mixed_object fixed_vec random_vec laplace_obj_hes_ laplace_obj_fun_ ',
'init_ran_like  Initialize Random Likelihood  ',' syntax private mixed_object fixed_vec random_vec ran_like_fun_ ran_like_a1fun_ ',
...
'ran_like_jac_check  Check User Defined ran_likelihood_jac  ',' syntax private mixed_object fixed_vec random_vec ran_like_fun_ ',
...
'whats_new_17  Changes and Additions to cppad_mixed During 2017  ',' 10-27 10-24 10-09 10-07 09-30 09-23 09-21 09-18 09-16 09-15 09-14 09-02 08-30 08-01 04-24 04-23 04-06 04-02 03-27 03-25 03-23 03-20 03-12 03-11 03-10 03-09 03-08 03-06 03-02 03-01 01-26 01-24 01-22 01-14 ',
