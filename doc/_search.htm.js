...
'run_cmake.sh  bin/run_cmake.sh: User Configuration Options  ',' verbose_makefile build_type cppad_prefix eigen_prefix other prefixes debug release cppad_cxx_flags cmake_libdir ldlt_cholmod checkpoint_newton_step optimize_cppad_function hide_ipopt_scaling for_hes_sparsity testing speed memory ',
...
'init_ran_hes  Initialize Hessian of Random Likelihood w.r.t Random Effects  ',' syntax private assumptions init_ran_hes_done_ mixed_object fixed_vec random_vec ran_hes_rcv_ ran_like_fun_ index order ran_hes_fun_ ',
'check_user_ran_hes  Check User Defined ran_likelihood_hes  ',' syntax private mixed_object fixed_vec random_vec ran_like_fun_ ran_hes_rcv_ ',
...
'init_ran_like  Initialize Random Likelihood  ',' syntax private init_ran_like_done_ mixed_object fixed_vec random_vec ran_like_fun_ ran_like_a1fun_ ran_like_a2fun_ ',
...
'ran_like_jac  Jacobian of Random Likelihood w.r.t. Random Effects  ',' syntax private assumptions purpose mixed_object fixed_vec random_vec example ',
...
'typedef  Types Defined in the CppAD Mixed Namespace  ',' syntax begin scalar a1_double a2_double a3_double vector s_vector d_vector a1_vector a2_vector a3_vector sparse sparse_rc sparse_rcv a1_sparse_rcv end ',
'configure.hpp  Preprocessor Configuration Symbols in configure.hpp  ',' private cppad_mixed_version cppad_mixed_for_hes_sparsity cppad_mixed_hide_ipopt_scaling cppad_mixed_optimize_ad_function cppad_mixed_checkpoint_newton_step cppad_mixed_ldlt_cholmod cppad_mixed_ldlt_class cppad_mixed_null_ptr ',
...
'ipopt_fixed_get_scaling_parameters  Inform Ipopt of Scaling Parameters  ',' ',
'ipopt_fixed_adaptive_derivative_check  Adaptive Step Size check of eval_grad_f and eval_jac_g  ',' syntax trace relative_step relative_tol infinity ok error_message_ adaptive_called_ scale_f_ scale_g_ jac_g_row_ jac_g_col_ prototype ',
...
'newton_step  Newton Step and Log Determinant Calculation  ',' syntax private purpose constructor destructor initialize a1fun hes_rcv theta size_var eval a1_theta_u_v a1_logdet_step checkpoint example ',
'newton_step.cpp  newton_step: Example and Test  ',' private ',
'newton_step_algo_ctor  Newton Step Algorithm Constructor  ',' syntax prototype private a1fun jac_a1fun hes_rcv theta cholesky_ n_fixed_ n_random_ a1fun_ a1_jac2hes_rcv_ ',
...
'newton_step_initialize  Initialize the Newton Step Checkpoint Function  ',' syntax prototype private newton_checkpoint a1fun jac_a1fun hes_rcv theta checkpoint_fun_ ',
...
'whats_new_18  Changes and Additions to cppad_mixed During 2018  ',' 02-08 02-07 02-05 01-23 01-22 01-21 01-15 01-14 ',
